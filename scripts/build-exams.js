...
const KNOWN_TYPES = ['gda', 'dao', 'ethics', 'biochem', 'pcod1', 'cario', 'oralrad', 'pcod2', 'patho', 'perio1', 'fixedpros', 'rempros', 'cd', 'ortho', 'icd', 'coralrad', 'occlusion', 'endo', 'implants', 'oralpath', 'painanx', 'perio2', 'omfs', 'pedo', 'mpm', 'oralmed', 'prosthrev', 'osii', 'tmd', 'pmgmt1', 'endorev', 'lasers', 'pmgmt2', 'surgperio'];
const KNOWN_SUBTYPES = {
  ...
  tmd: ['midterm', 'final'],
  pmgmt1: ['exam1', 'exam2', 'midterm', 'final'],
  pmgmt2: ['exam1', 'exam2', 'final'],
};
